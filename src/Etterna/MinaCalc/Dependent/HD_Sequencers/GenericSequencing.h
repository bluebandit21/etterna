...
/// ms to pass that definitely means an anchor has finished and started a new
/// one
...
struct Finger_Sequencing
{
	...
	/// rather than a buffer cap maybe a len cap will be more scalable, track
	/// the difficulty at the cap and when queried beyond it, just return this
	/// value
...
struct AnchorSequencer
{
	...
	/// information for each column to store in the movingwindow_max, this
	/// interval
