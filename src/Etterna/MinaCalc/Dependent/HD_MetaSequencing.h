...
/// 1212, 2121, etc
/// cccccc is cross column, cross column, cross column more colloquially known
/// as either an oht, or a roll, depending on the timing, since the definition
/// is timing dependent we will simply use the pattern configuration to refer to
/// it, until timing checks are run only called if both now and last_last are
