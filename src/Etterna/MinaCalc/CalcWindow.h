...
{
	/// ok there's actually a good reason for indexing this way because it's
	/// more intuitive since we are scanning row by row the earliest values in
	/// the window are the oldest
