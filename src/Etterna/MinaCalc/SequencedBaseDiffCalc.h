...
struct techyo
{
	  ...
	  -> float
	{
		...
		// we definitely don't want to pure average here because we don't want
		// tech to only be files with strong runningman pattern detection, but
		// we could probably do something more robust at some point
